...
![date représentative du film qui est un voyage dans le temps le 21 Octobre 1985]({% link images/fb_retour-vers-futur-cafe.jpg %}) 

** Ce qui me passionne **
 ce sont les grosses bécanes , et les gens qui ont travaillé dessus, sur un supercalculateur , certains français (non connus) ont participé a des projets
(image 2.jpg) Dans un Tilt une photo (noir et blanc) d'ingenieurs avec des cartes de super calculateurs. 
